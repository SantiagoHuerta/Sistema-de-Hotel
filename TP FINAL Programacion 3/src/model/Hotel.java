 ...
 * administracion del hotel, siendo esta las listas (mapas) de habitaciones, conserjes, reservas, clientes, datos del
...
public class Hotel {
    ...
    private Hotel() {
        ...
        if ((conserjes = IOGenericoUtil.leerObjeto(Archivos.CONSERJES)) == null) {
            System.out.println("No se ha podido leer objeto Conserjes. Contacte al administrador.");
    ...
    /**
     * Lista todos los conserjes en el sistema.
     */
    ...
    /**
     * Agrega un objeto de tipo Conserje al mapa de conserjes.
     * @see Conserje
     * @param c El conserje a agregar
     */
    ...
    /**
     * Quita un conserje del mapa de conserjes.
    ...
    * no sea valida*/
    ...
    /**
     * Devuelve un objeto de tipo Conserje segun la clave pasada por parametro. Arroja un NullPointerException
    ...
    /**
     * Verifica si en el mapa existe un Conserje.
     * @param key La clave asignada al elemento a encontrar
     * @return true/false
     */
    public boolean existeConserje(String key) {
        return conserjes.containsKey(key);
    }
