...
/**
 * Clase abstracta de la cual derivan dos clases concretas, Admin y Conserje. Posee los atributos fundamentales que
...
public abstract class Usuario implements Serializable {
    ...
    public void modificarDatosUsuario(Scanner scanner, Hotel hotel) {
        ...
        if (this instanceof Admin) {
        ...
        } else if (this instanceof Conserje) {

            /*Se impide que el ID de conserje coincida con el de Admin y que dicho ID sea 'admin'*/
            if (hotel.existeAdmin(id)) {
                ...
                return;
                /*Si existe conserje con un ID igual al introducido y no es el mismo que el del conserje que
        ...
        if (userConfirm.equals("s") || userConfirm.equals("S")) {
            /*Segun si el usuario es Admin o Conserje, el cambio se realiza de manera diferente*/
            if (this instanceof Admin) {
                setId(id);
                ...
                hotel.removerConserje(this.id);
                setId(id);
                setPassword(new Password(psw));
                setNombre(nombre);

                hotel.agregarConserje((Conserje) this);
            }
